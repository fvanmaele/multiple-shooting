...
dealii::Vector<FP_Type> operator*(FP_Type a, dealii::Vector<FP_Type> rhs)
{
  rhs *= a;
  return rhs;
}

dealii::Vector<FP_Type> operator*(dealii::Vector<FP_Type> lhs, FP_Type a)
{
  lhs *= a;
  return lhs;
}

dealii::Vector<FP_Type> operator+(dealii::Vector<FP_Type> lhs,
...
dealii::Vector<FP_Type> std_to_Vector(const std::vector<FP_Type> &v) {
